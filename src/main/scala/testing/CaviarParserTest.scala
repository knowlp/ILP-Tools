...
/*
   ...
   def main(args: Array[String]) {
    ...
    //parseCaviar("/home/nkatz/dev/CAVIAR-abrupt/02-Walk2")
    parseCaviar("/home/nkatz/dev/CAVIAR-abrupt/07-Browse4") // This has no pisitive examples for group activities.
