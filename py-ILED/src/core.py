...
class core():
    ...
    twoback = os.path.dirname(os.path.dirname(cwd))
    
    
    
    bk = os.path.join('py-ILED','knowledge','bk.lp')
    
    examples = os.path.join(cwd,'knowledge','examples.lp') 
    
    modes = os.path.join('py-ILED','knowledge','modes') 
    
    modeHsvarbed = []
    
    modeBsvarbed = []
    
    clingo = os.path.join(cwd,'lib','./clingo') 
    
    abdinp = os.path.join('py-ILED','runtime','abdin.lp')
    
    dedinp = os.path.join('py-ILED','runtime','dedin.lp')
    
    indinp = os.path.join('py-ILED','runtime','indin.lp')
    
    helper = os.path.join('py-ILED','runtime','helper.lp')
    
    ground = os.path.join('py-ILED','runtime','ground.lp')
    
    subsumes = os.path.join('py-ILED','pl','sub.pl')
    
    caviar_constr = os.path.join('py-ILED','knowledge','caviar-constr.lp')
    
    example_coverage_constr = os.path.join('py-ILED','knowledge','exmpl-cov-constr.lp')
    
    example_reject_constr = os.path.join('py-ILED','knowledge','exmpl-reject-constr.lp')
    
    kernel_path = os.path.join('py-ILED','runtime','kernel-set.lp')
    
    var_kernel_path = os.path.join('py-ILED','runtime','var-kernel-set.lp')
    
    prior_theory_path = os.path.join('py-ILED','runtime','prior-theory.lp')
    
    final_result_file = os.path.join('py-ILED','theory')
    
    crossval_path = os.path.join('py-ILED','runtime','crossval.lp')
    
    prior_theory_debug = os.path.join('py-ILED','dev-debug','debug-prior-theory.lp')
    
    py_prior_theory_debug = os.path.join('py-ILED','dev-debug')
