...
for the DrivingQuality high-level event. To experiment with learning DrivingQuality
...
DrivingQuality high-level event is not "flat", meaning that it does not depends on
...
learn a definition for DrivingQuality assuming no such knowledge at all. To this end,
