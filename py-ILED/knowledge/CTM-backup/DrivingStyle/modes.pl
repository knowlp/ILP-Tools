...
modeb(*,not_initiatedAt(sharp_turn(+vehicleId,+vehicleType,#fv_sharp_turn),+ttime)).
modeb(*,not_terminatedAt(sharp_turn(+vehicleId,+vehicleType,#fv_sharp_turn),+ttime)).
modeb(*,not_initiatedAt(abrupt_acceleration(+vehicleId,+vehicleType,#fv_abrupt_acceleration),+ttime)).
modeb(*,not_terminatedAt(abrupt_acceleration(+vehicleId,+vehicleType,#fv_abrupt_acceleration),+ttime)).
modeb(*,not_initiatedAt(abrupt_deceleration(+vehicleId,+vehicleType,#fv_abrupt_deceleration),+ttime)).
modeb(*,not_terminatedAt(abrupt_deceleration(+vehicleId,+vehicleType,#fv_abrupt_deceleration),+ttime)).
